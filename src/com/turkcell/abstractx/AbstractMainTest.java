...
public class AbstractMainTest {
	...
	public static void main(String[] args) {
		...
		// Lenovo
		System.out.println("\n******** Lenovo Class (Sub Class) ***********************");
		Lenovo lenovo = new Lenovo("lenovo-cpu", "lenovo-ram", "lenovo-anakart", "lenovo-port");
		lenovo.govdeliMethod();// Polymorphism:
		lenovo.govdesizMethod("Hamit");// Polymorphism:
